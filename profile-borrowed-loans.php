<?php
require('actions/users/showYourBorrowedLoansAction.php'); 
...
<title>Your Borrowed Loans - Instant Borrow</title>
...
<div class="everything-except-header">
	...
	<div class="loan-request">
		...
		<a href="lend-yeslogin.php"><button class="load-more">Lend Money</button></a>
