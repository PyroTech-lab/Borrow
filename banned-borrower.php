...
<div class="popup-image" id="popup-image">
	...
	<div class="image-div" id="image-div">
		...
		<div class="popup-text2"><span>This is a Picture of <span style="font-weight: 500; overflow-wrap: break-word;"><?= mb_strimwidth($name, 0, 50, "..."); ?></span>.</br>Instant Borrow gives as much Information as possible about the Borrower to facilitate the Repayment Process.</span></div>
...
<div class="main">
	...
	<div class="payment2">
		...
		<div class="chat-text" style="margin-top: 20px; margin-bottom: 30px;"><span class="subtext2"><?= mb_strimwidth($username_borrower, 0, 13, "..."); ?></span> Hasn't Repaid you and has been <span style="color: red;">Banned</span>.</br>This is the Information we Have About him:</div>
