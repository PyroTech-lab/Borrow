...
<div class="main">
	...
	<h2 class="main-title">Lend Money to <a href="user-profile.php?id=<?= $id_borrower; ?>" style="text-decoration: none;"><span style="color: #00c4ff; font-weight: bold;"><?= $username_borrower; ?></span></a></h2>
...
<div class="borrower-details">
	<p class="subsection-title">Borrower Information</p>
		...
		<div style="margin-top: -70px; margin-left: 80px;"><a href="user-profile.php?id=<?= $id_borrower; ?>" style="text-decoration: none;"><span style="color: #00c4ff; font-weight: bold; font-size: 1.45rem;"><?= $username_borrower; ?></span></a><img class="country-icon" src="assets/images/country-icons/<?=$country?>.png"><span class="location-hidden">Location: <span class="location-text"><?=$country?></span></span></br><span>Member since <?= date('F Y', strtotime($user_join_date)); ?></span></div>
		</div>
