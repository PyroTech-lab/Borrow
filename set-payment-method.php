...
<div class="everything-except-header">
	...
	<input name="remove_chime" type="submit" value="Remove Account" class="delete-button">
		...
		<p style="font-weight: 500; margin-top: 40px;">If you Have any Questions about Payment Methods, Refer to our <a href="faq.php" style="text-decoration: none; color: #3d91e0;">FAQ's</a> Or <a href="support.php" style="text-decoration: none; color: #3d91e0;">Contact our Support team.</a></p>
