...
<div class="popup-phone-number" id="popup-phone-number">
	...
	<div class="phone-number-div" id="phone-number-div">
		...
		<p class="popup-phone-text"><?= $verified_orNot; ?></p>
...
<div class="main">
	...
	<h2 class="main-title" style="overflow: none;">Lend<span class="money-text"> Money</span> to <a href="user-profile.php?id=<?= $id_borrower; ?>" style="text-decoration: none;"><span style="color: #00c4ff; font-weight: 500;"><span class="name-1"><?= mb_strimwidth($username_borrower, 0, 18, "..."); ?></span><span class="name-2"><?= mb_strimwidth($username_borrower, 0, 13, "..."); ?></span><span class="name-3"><?= mb_strimwidth($username_borrower, 0, 9, "..."); ?></span><span class="name-4"><?= mb_strimwidth($username_borrower, 0, 7, "..."); ?></span></span></a></h2>
