...
$getAllQuestions = $bdd->query('SELECT ROUND(((repayment_amount/loan_amount)-1)*100) AS interest, id, loan_amount, repayment_amount, repayment_date, request_date, id_borrower, username_borrower, borrower_trustscore FROM loan WHERE status = "request" ORDER BY id DESC LIMIT '.$limitLow.','.$limitHigh.'');
...
if (isset($_GET['sortby_loan_amount'])){
    ...
    $getAllQuestions = $bdd->query('SELECT ROUND(((repayment_amount/loan_amount)-1)*100) AS interest, id, loan_amount, repayment_amount, repayment_date, request_date, id_borrower, username_borrower, borrower_trustscore FROM loan WHERE status = "request" ORDER BY loan_amount+0 ASC LIMIT '.$limitLow.','.$limitHigh.'');
...
if (isset($_GET['sortby_repayment_date'])){
    ...
    $getAllQuestions = $bdd->query('SELECT ROUND(((repayment_amount/loan_amount)-1)*100) AS interest, id, loan_amount, repayment_amount, repayment_date, request_date, id_borrower, username_borrower, borrower_trustscore FROM loan WHERE status = "request" ORDER BY repayment_date ASC LIMIT '.$limitLow.','.$limitHigh.'');
...
if (isset($_GET['sortby_interest'])){
    ...
    $getAllQuestions = $bdd->query('SELECT ROUND(((repayment_amount/loan_amount)-1)*100) AS interest, id, loan_amount, repayment_amount, repayment_date, request_date, id_borrower, username_borrower, borrower_trustscore FROM loan WHERE status = "request" ORDER BY interest+0 DESC LIMIT '.$limitLow.','.$limitHigh.'');
