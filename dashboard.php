...
<div class="main">
	...
	<div class="main-right">
		...
		<div class="latest-requests"><p style="font-size: 1.15rem; font-weight: 500; color: #383838;">Latest Loan Request<span style="display: <?= $requests_display; ?>">s</span>:</p></div>
