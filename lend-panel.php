...
<div class="main">
	...
	<div class="chat-div">
		...
		<div class="chat-text"><span style="color: red;">Never Lend Money without Establishing communication with the Borrower first.</span></div>
		<button class="chat-button">Contact <span><?= $username_borrower; ?></span></button><span class="phone-hidden">Phone Number: <span class="phone-text"><?=$borrower_phone?></span></span>
	</div>
