...
<div style="min-height: calc(100vh - 593px); width: 100%;">

<div class="main">
<h1 class="title">Get in Touch with</br>Instant Borrow</h1>

<p class="subtitle">Have a <span class="highlighted">Question</span>, a <span class="highlighted">Request</span> or anything else you want to <span class="highlighted">Tell us?</span></br>Our Team is Here to Listen to You and Reply as Quickly as Possible.</p>
