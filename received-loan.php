...
require('actions/questions/LoanReceivedAction.php');
...
<title><?= $loan_amount; ?>$ Loan Received from <?= $username_lender; ?> - Instant Borrow</title>
...
<div class="main">
	...
	<div class="loan-recap">
		...
		<div class="column-1">
		<div class="text">Amount Received</br><span class="subtext1" style="color: #2b80ff"><?= $loan_amount; ?>$</span></div>
		...
		<div class="column-3">
		<div class="text">Payment Method</br><span class="subtext2"><?= $payment_method_payment; ?></span></div>
		<div class="text">Transaction ID</br><span class="subtext2-id"><?= mb_strimwidth($payment_transaction_id, 0, 14, "..."); ?></span></div>
		</div>
	</div>
	
	<div class="loan-recap-2">
		<div class="subtitle"><span>Loan Received</span></div>
		<div class="text" style="margin-top: 50px;"><span class="text-left">Amount Received:</span><span class="text-right" style="color: #2b80ff; margin-top: -10px;"><?= $loan_amount; ?>$</span></div>
		</br>
		...
		<div class="text" style="margin-top: 45px;"><span class="text-left">Payment Method:</span><span class="text-right" style="font-size: 1.15rem;"><?= $payment_method_payment; ?></span></div>
		</br>
	...
	<span>Amount Received on your Account may be Slightly Lower due to <?= $payment_method_payment; ?>'s Fees.</span>
	</div>
