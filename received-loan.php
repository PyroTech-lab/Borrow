...
<div class="main">
	...
	<div class="loan-recap">
		...
		<div class="column-1">
		<div class="text">Amount Received</br><span class="subtext1"><?= $loan_amount; ?>$</span></div>
		<div class="text">Instant Borrow Fee</br><span class="subtext1">0$</span></div>
		</div>
		<div class="column-2">
		<div class="text">Lender</br><a href="user-profile-yeslogin.php?id=<?= $id_lender; ?>" target="blank" style="text-decoration: none;"><span class="subtext2"><?= $username_lender; ?></span></a></div>
		<div class="text">Repayment Date</br><span class="subtext1" style="color: red;"><?= date('M jS, Y', strtotime($repayment_date)); ?></span></div>
		</div>
		<div class="column-3">
		<div class="text">Payment Method</br><span class="subtext2"><?= $payment_method_payment; ?></span></div>
		<div class="text">Transaction ID</br><span class="subtext2"><?= $payment_transaction_id; ?></span></div>
		</div>
	</div>
